...
sum=0
for (i in 1:n)
  sum= sum + log(daltbinom(x=i, p=p, theta=theta, n=n))
}
...
```{r}
data = read_csv('/Users/tobijonas/lab-10-point-estimation-tjonas5/pdc2024.csv')
data2= filter(data, as.numeric(Night) < 17) |> 
